...
return [
    ...
    'index.meta_keywords' => '',
    'index.header' => 'Your One-Stop Platform for Everything',
    'index.subheader' => '💬 Chat Widgets &nbsp;&nbsp;&nbsp; 🛠 Integrations Hub &nbsp;&nbsp;&nbsp; 📌 Digital Portfolios &nbsp;&nbsp;&nbsp; 📣 Social Media Schedulers &nbsp;&nbsp;&nbsp; 📊 Analytics Dashboards &nbsp;&nbsp;&nbsp; 🚀 Link Redirects &nbsp;&nbsp;&nbsp; 📷 Image Optimizers',
    'index.sign_up' => 'Get Started',
    'index.example' => 'Bio page Demo',
    'index.stars' => 'Loved by 100+ creators',

    'index.presentation1.header' => 'Text to Speech',
    'index.presentation1.subheader' => 'Effortlessly convert text into rich, natural-sounding audio. Perfect for accessibility, storytelling, and content creation',
    'index.presentation1.feature1' => 'Multilingual voices with diverse accents.',
    'index.presentation1.feature2' => 'Adjustable speed, pitch, and tone.',
    'index.presentation1.feature3' => 'Downloadable audio in MP3 format.',
    'index.presentation1.feature4' => 'Ideal for podcasts and audiobooks.',


    'index.presentation2.header' => 'BBCode to HTML Converter',
    'index.presentation2.subheader' => 'Instantly transform BBCode into clean HTML with ease—no technical expertise required',
    'index.presentation2.feature1' => 'Real-time, accurate tag conversion.',
    'index.presentation2.feature2' => 'Clean, error-free HTML output guaranteed.',
    'index.presentation2.feature3' => 'Supports all major BBCode tags.',
    'index.presentation2.feature4' => 'Preview BBCode and HTML side-by-side.',

    'index.presentation3.header' => 'Barcode Reader',
    'index.presentation3.subheader' => 'A powerful tool to scan and decode barcodes with accuracy, enhancing productivity and convenience',
    'index.presentation3.feature1' => 'Read multiple barcode formats instantly.',
    'index.presentation3.feature2' => 'Works offline and online seamlessly.',
    'index.presentation3.feature3' => 'Decodes barcodes from images or live.',
    'index.presentation3.feature4' => 'Export data for analysis or use.',
    'index.presentation3.feature5' => 'Essential for retail and logistics.',

    'index.presentation4.header' => 'Image Optimizer',
    'index.presentation4.subheader' => 'Reduce image size without sacrificing quality to ensure fast-loading websites and apps',
    'index.presentation4.feature1' => 'Reduces file size for speed.',
    'index.presentation4.feature2' => 'Retains high clarity post-optimization.',
    'index.presentation4.feature3' => 'Supports JPEG, PNG, GIF formats.',
    'index.presentation4.feature4' => 'Batch processes multiple files quickly.',

    'index.presentation5.header' => 'Character Counter',
    'index.presentation5.subheader' => 'Track your text’s length in real time to create content that fits every requirement',
    'index.presentation5.feature1' => 'Counts characters, words, and spaces.',
    'index.presentation5.feature2' => 'Highlights over-limit text automatically.',
    'index.presentation5.feature3' => 'Multi-language support for diverse needs.',
    'index.presentation5.feature4' => 'Export results for SEO or documentation.',
    ...
    'index.domains.header' => 'File Manager ',
    'index.domains.subheader' => 'Organize, manage, and share files with ease and efficiency.',

    'index.projects.header' => 'Responsive Design ',
    'index.projects.subheader' => 'Seamless experience across all devices for optimal viewing.',

    'index.file_links.header' => 'Secure Sharing',
    'index.file_links.subheader' => 'Share files securely with password protection and encryption.',

    'index.vcard_links.header' => 'Multi-Language Tools',
    'index.vcard_links.subheader' => 'Reach global users with easy language translation and support.',

    'index.event_links.header' => 'Easy Integrations',
    'index.event_links.subheader' => 'Connect effortlessly with popular apps and services for flexibility.',

    'index.splash_pages.header' => 'Real-Time Analytics',
    'index.splash_pages.subheader' => 'Monitor performance and make data-driven decisions instantly.',
    ...
    'index.testimonials.one.text' => 'I\'ve integrated the tools into my workflow seamlessly. The easy integrations allow me to connect with my favorite platforms, saving time and reducing the hassle. These tools are well-built and incredibly user-friendly. Highly recommended!',
    'index.testimonials.one.name' => 'Kasun Wijesinghe',
    'index.testimonials.one.attribute' => 'Software Engineer, Matara',
    'index.testimonials.two.text' => 'The responsive design capabilities are incredible! My marketing campaigns are now consistent across all devices. And, the multi-language tools allow me to reach clients effortlessly. It’s like having a digital marketing assistant in my pocket!',
    'index.testimonials.two.name' => 'Dilani Fernando',
    'index.testimonials.two.attribute' => 'Digital Marketer, Galle',
    'index.testimonials.three.text' => 'As a freelance web developer, the File Manager tool has made sharing files with clients. The real-time analytics feature also helps me track how my clients interact with the files I share. It’s a must-have for those who manage multiple projects!',
    'index.testimonials.three.name' => 'Chathura Perera',
    'index.testimonials.three.attribute' => 'Web Developer, Colombo',

    'index.faq.header' => '%1$sAnswers%2$s for your common %1$squestions%2$s',
    'index.faq.one.question' => 'What makes your tools unique?',
    'index.faq.one.answer' => 'Our tools are fast, reliable, and designed to save you time while simplifying your tasks—everything you need in one place!',
    'index.faq.two.question' => 'Is there a risk-free way to try your platform?',
    'index.faq.two.answer' => 'Yes, enjoy a 14-day free trial to experience all premium features without any obligations.',
    'index.faq.three.question' => 'Can I switch plans easily?',
    'index.faq.three.answer' => 'Of course! Upgrade, downgrade, or cancel anytime with just a few clicks—total flexibility.',
    'index.faq.four.question' => 'How secure is my data?',
    'index.faq.four.answer' => 'Your privacy is our priority. We ensure advanced encryption and safe sharing for all your files.',

    'index.cta.header' => 'Get started',
    'index.cta.subheader' => 'Ready for Smarter Work? Get Started Now!',
    ...
    'create_biolink_vcard_modal.vcard_phone_number_label_help' => 'Leave empty to use the default phone generated label. Custom labels do not work on Android devices.',
