...
<form name="update_biolink_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="<?= 'map_markers_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('create_biolink_map_modal.markers') ?></label>
        ...
        <small class="form-text text-muted"><?= l('create_biolink_map_modal.markers_help') ?></small>
    </div>
