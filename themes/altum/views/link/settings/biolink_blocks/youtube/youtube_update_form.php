...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'youtube_autoplay_' . $row->biolink_block_id ?>"><?= l('create_biolink_video_modal.video_autoplay') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'youtube_controls_' . $row->biolink_block_id ?>"><?= l('create_biolink_video_modal.video_controls') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'youtube_loop_' . $row->biolink_block_id ?>"><?= l('create_biolink_video_modal.video_loop') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'youtube_muted_' . $row->biolink_block_id ?>"><?= l('create_biolink_video_modal.video_muted') ?></label>
    </div>
